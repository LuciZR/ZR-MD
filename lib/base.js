const {getRandom,getBuffer,fetchJson,runtime,sleep,isUrl,bytesToSize,getSizeMedia,check} = require('ZR');
...
function linkPreview(options={}) {
	...
	const opt = {
	       showAdAttribution: true,
               title: options.title || config.LINK_PREVIEW.split(/[;,|]/)[0] || 'ZR-MD',
