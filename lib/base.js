const {getRandom,getBuffer,fetchJson,runtime,sleep,isUrl,bytesToSize,getSizeMedia,check} = require('𝐀𝐈𝐙𝐄𝐍-𝐌𝐃');
...
function linkPreview(options={}) {
	...
	const opt = {
	       showAdAttribution: true,
               title: options.title || config.LINK_PREVIEW.split(/[;,|]/)[0] || '𝐀𝐈𝐙𝐄𝐍-𝐌𝐃',
               body:  options.body || config.LINK_PREVIEW.split(/[;,|]/)[1],
               mediaType: 1,
               thumbnailUrl: options.url || config.LINK_PREVIEW.split(/[;,|]/)[2] || 'https://raw.githubusercontent.com/LuciZR/ZR-MD/main/ZR.png',
               sourceUrl: config.LINK_PREVIEW.split(/[;,|]/)[3] || 'https://whatsapp.com/channel/0029Va9S1ZW17En4Yh6hz63R'
             }
             return opt
}
